									...
									<div class="so-filter-content-opts-container">
										<div class="so-filter-option opt-select  opt_enable" data-type="manufacturer" data-manufacturer_value="8" data-count_product="4" data-list_product="30,58,61,105">
											<div class="so-option-container">
												...
												<label><img src="theme/image/placeholder.png" style="width: 20px; height: 20px;"> Apple</label>
												<div class="option-count ">
													<span>4</span>
													<i class="fa fa-times"></i>
												</div>
										...
										<div class="so-filter-option opt-select  opt_enable" data-type="manufacturer" data-manufacturer_value="10" data-count_product="1" data-list_product="68">
											<div class="so-option-container">
												...
												<label><img src="theme/image/placeholder.png" style="width: 20px; height: 20px;"> Sony</label>
												<div class="option-count ">
													<span>1</span>
													<i class="fa fa-times"></i>
												</div>
				...
				<div class="moduletable module so-extraslider-ltr best-seller best-seller-custom">
												...
												<div class="item-image">
													<div class="item-img-info product-image-container ">
														...
														<a class="lt-image" data-product="104" href="#" target="_self" title="Toshiba Pro 21&quot;(21:9) FHD  IPS LED 1920X1080 HDMI(2)">
															<img src="theme/image/catalog/demo/product/electronic/25.jpg" alt="Toshiba Pro 21&quot;(21:9) FHD  IPS LED 1920X1080 HDMI(2)">
														</a>
													</div>
												</div>
											</div>
											<div class="media-body">
												<div class="item-info">
													...
													<div class="item-title">
														<a :href="route('single_feature')" target="_self" title="Toshiba Pro 21&quot;(21:9) FHD  IPS LED 1920X1080 HDMI(2) ">
									  ...
									  <div class="item-wrap-inner">
										 <div class="media-left">
											<div class="item-image">
											   <div class="item-img-info product-image-container ">
												  ...
												  <img src="theme/image/catalog/demo/product/electronic/19.jpg" alt="Compact Portable Charger (Power Bank) with Premium">
												  </a>
											   </div>
											</div>
										 </div>
										 <div class="media-body">
											<div class="item-info">
											   <!-- Begin title -->
											   <div class="item-title">
												  <a :href="route('single_feature')" target="_self" title="Compact Portable Charger (Power Bank) with Premium ">
									  ...
									  <div class="item-wrap-inner">
										 <div class="media-left">
											<div class="item-image">
											   <div class="item-img-info product-image-container ">
												  ...
												  <img src="theme/image/catalog/demo/product/travel/8.jpg" alt="Philipin Tour Group Manila/ Pattaya / Mactan ">
												  </a>
											   </div>
											</div>
										 </div>
										 <div class="media-body">
											<div class="item-info">
											   <!-- Begin title -->
											   <div class="item-title">
												  <a :href="route('single_feature')" target="_self" title="Philipin Tour Group Manila/ Pattaya / Mactan  ">
									  ...
									  <div class="item-wrap-inner">
										 <div class="media-left">
											<div class="item-image">
											   <div class="item-img-info product-image-container ">
												  ...
												  <img src="theme/image/catalog/demo/product/electronic/4.jpg" alt="Portable  Compact Charger (External Battery) t45">
												  </a>
											   </div>
											</div>
										 </div>
										 <div class="media-body">
											<div class="item-info">
											   <!-- Begin title -->
											   <div class="item-title">
												  <a :href="route('single_feature')" target="_self" title="Portable  Compact Charger (External Battery) t45 ">
				 ...
				 <div class="module banner-left hidden-xs ">
					<div class="static-image-home-left banners">
					   <div><a title="Static Image" href="#"><img src="theme/image/catalog/demo/banners/image-left.jpg" alt="Static Image"></a></div>
					</div>
				 </div>
			</aside>
						...
						<div class="products-list grid">
								...
								<div class="product-item-container">
									<div class="left-block">
										<div class="product-image-container  second_img  ">
											<a :href="route('single_feature')" title="Lorem Ipsum dolor at vero eos et iusto odi  with Premium ">
												<img src="theme/image/catalog/demo/product/electronic/26.jpg " alt="Lorem Ipsum dolor at vero eos et iusto odi  with Premium " title="Lorem Ipsum dolor at vero eos et iusto odi  with Premium " class="img-1 img-responsive">
												<img src="theme/image/catalog/demo/product/electronic/30.jpg" alt="Lorem Ipsum dolor at vero eos et iusto odi  with Premium " title="Lorem Ipsum dolor at vero eos et iusto odi  with Premium " class="img-2 img-responsive">
											</a>
										</div>
									...
									<div class="right-block">
										<div class="caption">
											<h4><a :href="route('single_feature')">Lorem Ipsum dolor at vero eos et iusto odi  with Premium </a></h4>
							...
							<div class="product-layout col-lg-4 col-md-4 col-sm-6 col-xs-6 ">
								<div class="product-item-container">
									<div class="left-block">
										<div class="product-image-container  second_img  ">
											<a :href="route('single_feature')" title="Computer Science saepe eveniet ut et volu redae ">
												<img src="theme/image/catalog/demo/product/electronic/23.jpg " alt="Computer Science saepe eveniet ut et volu redae " title="Computer Science saepe eveniet ut et volu redae " class="img-1 img-responsive">
												<img src="theme/image/catalog/demo/product/electronic/15.jpg" alt="Computer Science saepe eveniet ut et volu redae " title="Computer Science saepe eveniet ut et volu redae " class="img-2 img-responsive">
											</a>
											<div class="box-label">
												<span class="label-product label-sale">
													Sale
									...
									<div class="right-block">
										<div class="caption">
											<h4><a :href="route('single_feature')">Computer Science saepe eveniet ut et volu redae </a></h4>
											<div class="total-price">
												<div class="price price-left">
								...
								<div class="product-item-container">
									<div class="left-block">
										<div class="product-image-container  second_img  ">
											...
											<img src="theme/image/catalog/demo/product/electronic/22.jpg " alt="Compact Portable Charger External " title="Compact Portable Charger External " class="img-1 img-responsive">
											<img src="theme/image/catalog/demo/product/electronic/23.jpg" alt="Compact Portable Charger External " title="Compact Portable Charger External " class="img-2 img-responsive">
											</a>
											<div class="box-label">
												<span class="label-product label-sale">
													Sale
									...
									<div class="right-block">
										<div class="caption">
											<h4><a :href="route('single_feature')">Compact Portable Charger External </a></h4>
											<div class="total-price">
												<div class="price price-left">
							...
							<div class="product-layout  col-lg-4 col-md-4 col-sm-6 col-xs-6 " >
								<div class="product-item-container">
									<div class="left-block">
										<div class="product-image-container  second_img  ">
											<a :href="route('single_feature')" title="Compact Portable Charger (Power Bank) with Premium ">
												<img src="theme/image/catalog/demo/product/electronic/19.jpg " alt="Compact Portable Charger (Power Bank) with Premium " title="Compact Portable Charger (Power Bank) with Premium " class="img-1 img-responsive">
												<img src="theme/image/catalog/demo/product/electronic/2.jpg" alt="Compact Portable Charger (Power Bank) with Premium " title="Compact Portable Charger (Power Bank) with Premium " class="img-2 img-responsive">
											</a>
											<div class="box-label">
												<span class="label-product label-sale">
													Sale
									...
									<div class="right-block">
										<div class="caption">
											<h4><a :href="route('single_feature')">Compact Portable Charger (Power Bank) with Premium </a></h4>
											<div class="total-price">
												<div class="price price-left">
							...
							<div class="product-layout  col-lg-4 col-md-4 col-sm-6 col-xs-6 " >
								<div class="product-item-container">
									<div class="left-block">
										<div class="product-image-container  second_img  ">
											<a :href="route('single_feature')" title="Compact Portable Charger (External Battery) T23 ">
												<img src="theme/image/catalog/demo/product/electronic/17.jpg " alt="Compact Portable Charger (External Battery) T23 " title="Compact Portable Charger (External Battery) T23 " class="img-1 img-responsive">
												<img src="theme/image/catalog/demo/product/electronic/15.jpg" alt="Compact Portable Charger (External Battery) T23 " title="Compact Portable Charger (External Battery) T23 " class="img-2 img-responsive">
											</a>
										</div>
									</div>
									<div class="box-label">
									...
									<div class="right-block">
										<div class="caption">
											<h4><a :href="route('single_feature')">Compact Portable Charger (External Battery) T23 </a></h4>
											<div class="total-price">
												<div class="price price-left">
							...
							<div class="product-layout  col-lg-4 col-md-4 col-sm-6 col-xs-6 " >
								<div class="product-item-container">
									<div class="left-block">
										<div class="product-image-container  second_img  ">
											<a :href="route('single_feature')" title="Compact Portable Charger (External Battery) ">
												<img src="theme/image/catalog/demo/product/electronic/13.jpg " alt="Compact Portable Charger (External Battery) " title="Compact Portable Charger (External Battery) " class="img-1 img-responsive">
												<img src="theme/image/catalog/demo/product/electronic/15.jpg" alt="Compact Portable Charger (External Battery) " title="Compact Portable Charger (External Battery) " class="img-2 img-responsive">
											</a>
											<div class="box-label">
											</div> 
										</div>
									...
									<div class="right-block">
										<div class="caption">
											<h4><a :href="route('single_feature')">Compact Portable Charger (External Battery) </a></h4>
											<div class="total-price">
												<div class="price price-left">
							...
							<div class="product-layout  col-lg-4 col-md-4 col-sm-6 col-xs-6 " >
								<div class="product-item-container">
									<div class="left-block">
										<div class="product-image-container  second_img  ">
											<a :href="route('single_feature')" title="Compact (External Battery Power Bank) with Premium ">
												<img src="theme/image/catalog/demo/product/electronic/12.jpg " alt="Compact (External Battery Power Bank) with Premium " title="Compact (External Battery Power Bank) with Premium " class="img-1 img-responsive">
												<img src="theme/image/catalog/demo/product/electronic/2.jpg" alt="Compact (External Battery Power Bank) with Premium " title="Compact (External Battery Power Bank) with Premium " class="img-2 img-responsive">
											</a>
										</div>
									</div>
									<div class="right-block">
										<div class="caption">
											<h4><a :href="route('single_feature')">Compact (External Battery Power Bank) with Premium </a></h4>
											<div class="total-price">
												<div class="price price-left">
							...
							<div class="product-layout  col-lg-4 col-md-4 col-sm-6 col-xs-6 " >
								<div class="product-item-container">
									<div class="left-block">
										<div class="product-image-container  second_img  ">
											<a :href="route('single_feature')" title=" Magnetic Air Vent Phone Holder for iPhone 7 / 7 Plus ">
												<img src="theme/image/catalog/demo/product/electronic/1.jpg " alt=" Magnetic Air Vent Phone Holder for iPhone 7 / 7 Plus " title=" Magnetic Air Vent Phone Holder for iPhone 7 / 7 Plus " class="img-1 img-responsive">
												<img src="theme/image/catalog/demo/product/electronic/10.jpg" alt=" Magnetic Air Vent Phone Holder for iPhone 7 / 7 Plus " title=" Magnetic Air Vent Phone Holder for iPhone 7 / 7 Plus " class="img-2 img-responsive">
											</a>
										</div>
										<div class="countdown_box">
											<div class="countdown_inner">
									...
									<div class="right-block">
										<div class="caption">
											<h4><a :href="route('single_feature')"> Magnetic Air Vent Phone Holder for iPhone 7 / 7 Plus </a></h4>
											<div class="total-price">
												<div class="price price-left">
													<span class="price-new">$98.00 </span> <span class="price-old">$122.00 </span>
												</div>
                            ...
                            <div class="product-layout  col-lg-4 col-md-4 col-sm-6 col-xs-6 " >
                                ...
                                <div class="left-block">
                                    <div class="product-image-container  second_img  ">
                                    <a :href="route('single_feature')" title="Portable  Compact Charger (External Battery) t45">
                                        <img src="theme/image/catalog/demo/product/electronic/4.jpg " alt=" Portable  Compact Charger (External Battery) t45" title="Portable  Compact Charger (External Battery) t45" class="img-1 img-responsive">
                                        <img src="theme/image/catalog/demo/product/electronic/6.jpg" alt="Portable  Compact Charger (External Battery) t45" title="Portable  Compact Charger (External Battery) t45" class="img-2 img-responsive">
                                    </a>
                                    </div>
                                    <div class="box-label">
                                ...
                                <div class="right-block">
                                    <div class="caption">
                                    <h4><a :href="route('single_feature')">Portable  Compact Charger (External Battery) t45</a></h4>
                                    <div class="total-price">
                                        <div class="price price-left">
